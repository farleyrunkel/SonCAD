...
void ViewportMouseControlDefault::MouseMove(const Graphic3d_Vec2d& pos, Aspect_VKeyMouse buttons, Aspect_VKeyFlags keys)
{
    qDebug() << "ViewportMouseControlDefault::MouseMove: ";
