...
WorkspaceController* VisualObject::workspaceController() const { return m_workspaceController; }

Handle(AIS_InteractiveContext) VisualObject::aisContext() const { return m_workspaceController->workspace()->aisContext(); }
