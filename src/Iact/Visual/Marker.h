...
public:
    Marker(const Handle(WorkspaceController)& WorkspaceController, Styles styles, const MarkerImage& image);
    Marker(const Handle(WorkspaceController)& WorkspaceController, Styles styles, QString imageName, int size);
