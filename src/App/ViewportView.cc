...
namespace Sun {
    ViewportView::ViewportView(QWidget* parent)
        ...
        connect(Core::appContext(), &Sun::AppContext::workspaceControllerChanged, [this](Sun_WorkspaceController* controller) {
            if (controller) {
                if (m_viewportPanel) {
                ...
                connect(Core::appContext(), &Sun::AppContext::viewportChanged, [this](Sun_Viewport* Viewport) {
                    if (Viewport) {
                ...
                connect(Core::appContext(), &Sun::AppContext::viewportControllerChanged,
